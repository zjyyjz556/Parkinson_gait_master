...
os.environ["CUDA_VISIBLE_DEVICES"] = '0'  # 或者'1' 调用运行GPU的编号
...
# 配置可使用的显存比例
config.gpu_options.per_process_gpu_memory_fraction = 80
...
#        early_stopping = EarlyStopping(monitor='val_loss', min_delta=0.01, patience=20, verbose=0, mode='auto')
        early_stopping = EarlyStopping(monitor='val_loss', min_delta=0.01, patience=1, verbose=0, mode='auto')
